...
const EventForm = (props) => {
    ...
    const [startDate, onStartDateChange] = useState(props.event ? new Date(props.event.startDate) : new Date());
    const [endDate, onEndDateChange] = useState(props.event ? new Date(props.event.endDate) : new Date());
    const [startTime, onStartTimeChange] = useState(props.event ? new Date(props.event.startTime) : new Date());
    const [endTime, onEndTimeChange] = useState(props.event ? new Date(props.event.endTime) : new Date());
